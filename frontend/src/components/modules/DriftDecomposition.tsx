...
interface DriftDecompositionProps {
  title?: string;
  data?: any[];
  onAction?: (action: string, payload: any) => void;
}

export const DriftDecomposition: React.FC<DriftDecompositionProps> = ({
  title = "Population Stability Index Feature Drift Table Component",
  data = [],
  onAction
}) => {
  ...
  return (
    <div className="bg-dark-card border border-dark-border rounded-xl p-5 space-y-4">
      ...
      <div className="p-4 bg-slate-900 rounded-lg border border-slate-800 text-xs text-gray-300">
        <p className="text-gray-400 mb-2">Operational Interface for Population Stability Index Feature Drift Table Component</p>
